...
def add_domain(domain):
  print "in_add"
  wiki1_file = open("wiki1_config.txt", "a")
  wiki1_file.write("\n")
  wiki1_file.write(domain)
  wiki1_file.close()
...
def update_domain(domain):
  ...
  print "-"+real_domain+"-"
  replaceAll("wiki1_config.txt", real_domain, domain)
...
class ClientThread(Thread): 
    ...
    def get_ip_rec(self, domain, action):
      ...
      wiki1_file = open("wiki1_config.txt", "r")
      for line in wiki1_file:
        wiki1_entry = line.split(" : ")[0]  
        print wiki1_entry + "-"
        print domain + "-"
        if wiki1_entry == domain:
          print "found domain"
          print line.split(" : ")[1]
